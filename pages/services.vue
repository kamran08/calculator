                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4 col-lg-4">
                            <a href="single-service.html" class="_services_card">
                                ...
                                <div class="_services_pic">
                                    <img class="_services_img" src="assets/img/pexels-fotoaibe-1571468.jpg" alt="" title="">
                                </div>
                                <div class="_text_center _services_card_btn">
                                    <button class="_2btn">Read More</button>
                                </div>
                        ...
                        <div class="col-12 col-md-4 col-lg-4">
                            <a href="single-service.html" class="_services_card">
                                ...
                                <div class="_services_pic">
                                    <img class="_services_img" src="assets/img/pexels-cottonbro-4107107.jpg" alt="" title="">
                                </div>
                                <div class="_text_center _services_card_btn">
                                    <button class="_2btn">Read More</button>
                                </div>
