<template>
  ...
  <div class="_banner_con">
    ...
    <div class="_banner_main">
      <h1 class="_banner_title">Lorem ipsum dolor sit amet.</h1>
      <p class="_banner_text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonmy ni euism laoreet dolore magna aliquam erat volutpat consectetuer adipiscing elit.</p>
      <a href="/book.html"><button class="_1btn _btn_large">Book a Appointment</button></a>
    </div>
  </div>
  <!-- Banner -->
  ...
  <div class="_sponsor">
    <div class="container">
      <div class="_sponsor_slider" style="
        --width: 120px;
        --height:90px;  
        --quantity:7;
      ">
  ...
  <div class="_why">
    <div class="container">
      <div class="_why_top_con">
        <h1 class="_1title">Why Choose Us</h1>

        <p class="_why_top_text">
      ...
      <div class="_why_con">
        <div class="row align-items-center">
          <div class="col-12 col-md-3">
            <ul class="_why_card_all">
              <li>
                <div class="_why_card">
                  <div class="_why_card_icon">
                    <i class='bx bx-diamond'></i>
                  </div>

                  <p class="_why_card_title">INSURED AND BONDED</p>
                  <p class="_why_card_text">
                    We keep your home sparkling clean and germ free. Our disinfecting process kills 99% of viruses.
                  </p>
                </div>
              </li>
              <li>
                <div class="_why_card">
                  <div class="_why_card_icon umbrella">
                    <i class='bx bx-leaf'></i>
                  </div>

                  <p class="_why_card_title">SPARKLING CLEAN</p>
                  <p class="_why_card_text">
          ...
          <div class="col-12 col-md-3">
            <ul class="_why_card_all _why_card_all_right">
              <li>
                <div class="_why_card">
                  <div class="_why_card_icon">
                  ...
                  <p class="_why_card_title">LEADING TECHNOLOGIES</p>
                  <p class="_why_card_text">
                    We use safe hospital-grade disinfectants and microfiber cleaning cloths to reduce contamination.
                  </p>
                </div>
              </li>
              <li>
                <div class="_why_card">
                  <div class="_why_card_icon women">
                    <i class='bx bxs-castle'></i>
                  </div>

                  <p class="_why_card_title">RELIABLE CREWS</p>
                  <p class="_why_card_text">
    ...
    <div class="container">
      <div class="row g-5">
        <div class="col-12 col-md-6 col-lg-6">
          <div class="_about_left">
            <h1 class="_1title _1title_left">Unbeatable Cleaning In Every Sector</h1>
             <div class="_about_text_main">
              <p class="_about_text">Moppers offering cleaning services in 1950 as a small window cleaner, located near Le Pigalle in Paris, France.</p>
              <p class="_about_text">Our disinfecting process kills 99% of common bacteria and viruses.  Our disinfecting process kills 99% of common bacteria and viruses. Shortly after opening, founder Mitchel Sweedon offered something special cleaning backed by a 100% best carpet cleaner satisfaction guarantee. As a result, his small business flourished & many more cleaning services were added in our company.</p>
             </div>

             <div class="_about_video">
              <div class="_about_video_icon">
        ...
        <div class="col-12 col-md-6 col-lg-6">
          <div class="_about_right">
            <div class="_about_pics">
              <div class="row">
                <div class="col-6">
            ...
            <div class="_about_right_bottom">
              <p class="_about_right_bottom_text">
                Our disinfecting process kills 99% of common bacteria and viruses. Something special cleaning backed by a 100% best carpet cleaner satisfaction guarantee. As a result, his small business flourished & many more cleaning services were added in our company.
              </p>
              <ul class="_about_mark">
                <li>
                ...
                <li>
                  <span><i class='bx bxs-badge-check'></i></span>
                  Showed a lady fitted our with far.
                </li>
                <li>
                  <span><i class='bx bxs-badge-check'></i></span>
                  Hourse cleansing
              ...
              <div class="_about_ceo_qu">
                <p class="_about_ceo_qu_text">
                  Illustrated magazine and housed in a nice, gilded frame. It showed a lady fitted out with a fur hat and hands
                </p>

                <p class="_about_ceo_name">
                  Alster Cook,
                  <span>Manager of service</span>
                </p>
              </div>
            </div>
          </div>
  ...
  <!-- Our Work Process -->
  <div class="_work">
    <h1 class="_1title _text_center">Our work Process</h1>
    <div class="_work_con">
      <div class="container">
        <div class="_work_con_main">
          <div class="row g-0">
            <!-- Item -->
            <div class="col-12 col-md-4 col-lg-3">
              <div class="_work_step">
                <div class="_work_step_icon">
                  <i class='bx bx-spray-can'></i>
                </div>

                <div class="_work_step_line">
                  <span>1</span>
                </div>

                <p class="_work_step_text">
                  Idea of denouncing pleasure and praising born.
                </p>
              </div>
            </div>
            <!-- Item -->
            ...
            <div class="col-12 col-md-4 col-lg-3">
              <div class="_work_step">
                ...
                <p class="_work_step_text">
                  The great explorer of the truth, master-builder.
                </p>
              </div>
            </div>
            <!-- Item -->
          ...
          <div class="col-12 col-md-12 col-lg-10">
            <div class="row justify-content-center">
              ...
              <div class="col-12 col-md-3 col-lg-3">
                <div class="_work_progress_item">
                  <div class="_work_progress_line one"></div>
                  <h1 class="_work_progress_val">527</h1>
                  <h1 class="_work_progress_text">COMPLETED PROJECTS</h1>
                </div>
              </div>
              <!-- item -->
              <!-- item -->
              <div class="col-12 col-md-3 col-lg-3">
                <div class="_work_progress_item">
                  <div class="_work_progress_line two"></div>
                  <h1 class="_work_progress_val">100</h1>
                  <h1 class="_work_progress_text">PLACES CLEANED</h1>
                </div>
              </div>
              <!-- item -->
              <!-- item -->
              <div class="col-12 col-md-3 col-lg-3">
                <div class="_work_progress_item">
                  <div class="_work_progress_line three"></div>
                  <h1 class="_work_progress_val">298</h1>
                  <h1 class="_work_progress_text">COMPLETED MOVINGS</h1>
                </div>
              </div>
              <!-- item -->
              <!-- item -->
              <div class="col-12 col-md-3 col-lg-3">
                <div class="_work_progress_item">
                  <div class="_work_progress_line four"></div>
                  <h1 class="_work_progress_val">400</h1>
                  <h1 class="_work_progress_text">HAPPY CUSTOMERS</h1>
                </div>
              </div>
              <!-- item -->
            </div>
  ...
  <div class="_homeBlog">
    <div class="container">
      <div class="_homeBlog_top">
        <h1 class="_1title _1title_left">LATEST FROM BLOG</h1>

        <a class="_see_all" href="blog.html">See all</a>
      </div>

      <div class="_homeBlog_card_main">
        <div class="row">
          <!-- Item -->
          <div class="col-12 col-md-4 col-lg-4">
            <div class="_homeBlog_card">
              <ul class="_homeBlog_card_meta">
                <li>Cleaning Tips</li>
              </ul>
  ...
  <div class="_pricing">
    <div class="container">
      <div class="_why_top_con">
        <h1 class="_1title">Our Services Plan</h1>
      ...
      <div class="row">
        <!-- Item -->
        <div class="col-12 col-md-4 col-lg-4">
          <div class="_pricing_box _one">
            <div class="_pricing_heading">
                <h2><span>$</span>40<sub>/Month</sub></h2>
            </div>
            <h4 class="_pricing_plan">Basic</h4>
            <ul class="_pricing_list">
                <li>Architect</li>
                <li>24/7 CUSTOMER SUPPORT</li>
                <li>2 UNIQUE CONCEPTS</li>
                <li>3-5 BUSINESS DAYS</li>
            </ul>
            <div class="_text_center _pricing_bottom">
                <a href="#" class="_2btn">Order Now</a>
            </div>
          </div>
        </div>
        <!-- Item -->
        <!-- Item -->
        <div class="col-12 col-md-4 col-lg-4">
          <div class="_pricing_box _two">
            <div class="_pricing_heading">
                <h2><span>$</span>70<sub>/Month</sub></h2>
            </div>
            <h4 class="_pricing_plan">Gold</h4>
            <ul class="_pricing_list">
                <li>Architect</li>
                <li>24/7 CUSTOMER SUPPORT</li>
                <li>2 UNIQUE CONCEPTS</li>
        ...
        <!-- Item -->
        <div class="col-12 col-md-4 col-lg-4">
          <div class="_pricing_box _three">
            <div class="_pricing_heading">
                <h2><span>$</span>120<sub>/Month</sub></h2>
            </div>
            <h4 class="_pricing_plan">PREMIUM</h4>
            <ul class="_pricing_list">
                <li>Architect</li>
                <li>24/7 CUSTOMER SUPPORT</li>
                <li>2 UNIQUE CONCEPTS</li>
